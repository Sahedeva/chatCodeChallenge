...
{ b: "apple", c: { d: "banana", e: ["grape", "APPLE"] }}
...
// 	return false;
	...
	// }
	// var example = Object.byString(someObj, 'part3[0].name');
	
	// "Object: "+objectInput+" Regex: "+regexInput + 
	// +"\nKey array: "+keyArray
	// " Object.byString(someObj, 'part3[0].name': "+example
// });


// Example of nested object and some object manipulation tests
// var someObject = {
//     'part1' : {
//         'name': 'Part 1',
//         'size': '20',
